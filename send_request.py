...
adjacency_list = [{"coupler_connector_pad_Q1": [("coupler_connector_pad_Q1", 0.56850),
                                                ("ground_main_plane", 37.28461),
                                                ("pad_bot_Q1", 2.00818),
                                                ("pad_top_Q1", 19.10774),
                                                ("readout_connector_pad_Q1", 0.22976)],
                   "ground_main_plane": [("ground_main_plane", 92.09372),
                                         ("pad_bot_Q1", 39.78914),
                                         ("pad_top_Q1", 39.86444),
                                         ("readout_connector_pad_Q1", 37.29686)],
                   "pad_bot_Q1": [("pad_bot_Q1", 1.42310),
                                  ("pad_top_Q1", 30.61038),
                                  ("readout_connector_pad_Q1", 19.21994)],
                   "pad_top_Q1": [("pad_top_Q1", 1.40275),
                                  ("readout_connector_pad_Q1", 2.00897)],
                   "readout_connector_pad_Q1": [("readout_connector_pad_Q1", 0.57194)]},
                  {"coupler_connector_pad_Q2": [("coupler_connector_pad_Q2", 0.55882),
                                                ("ground_main_plane", 38.62522),
                                                ("pad_bot_Q2", 2.1826),
                                                ("pad_top_Q2", 22.9334),
                                                ("readout_connector_pad_Q2", 0.21522)],
                   "ground_main_plane": [("ground_main_plane", 91.51869),
                                         ("pad_bot_Q2", 49.28298),
                                         ("pad_top_Q2", 49.29706),
                                         ("readout_connector_pad_Q2", 38.67319)],
                   "pad_bot_Q2": [("pad_bot_Q2", 1.60685),
                                  ("pad_top_Q2", 45.23961),
                                  ("readout_connector_pad_Q2", 23.06437)],
                   "pad_top_Q2": [("pad_top_Q2", 1.59200),
                                  ("readout_connector_pad_Q2", 2.17691)],
                   "readout_connector_pad_Q2": [("readout_connector_pad_Q2", 0.57114)]},
